...
\cventry
{A personal project to develop an AI program which plays the game Starcraft: Broodwar} % Brief explanation
{TeraZerg} % Project name
...
\cventry
{A web implementation which evaluates submitted code automatically} % Brief explanation
