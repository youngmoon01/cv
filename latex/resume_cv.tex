...
\name{Youngmoon}{Eom}
\address{Yuksa Apt. 201-703, Hwarangro, Nowon-gu, Seoul, Rep. of KOREA}
\mobile{(+82) 10-4384-7123}

\email{eomyoungmoon01@gmail.com}
...
\position{Software Engineer{\enskip\cdotp\enskip}Distributed Computing Engineer} % Your expertise/fields
%\quote{``Make the change that you want to see in the world."} % A quote or statement

\makecvfooter{\today}{Youngmoon Eom~~~·~~Curriculum Vitae}{\thepage} % Specify the letter footer with 3 arguments: (<left>, <center>, <right>), leave any of these blank if they are not needed
...
\input{cv-sections/qualifications.tex}
\input{cv-sections/skills.tex}
\input{cv-sections/educations.tex}
\input{cv-sections/experiences.tex}
